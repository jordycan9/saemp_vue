                   ...
                   <div id="solicitudGuardia"> <br><br>
                          ...
                          <div id="datos">
                              <p id="encabezado">
                                  <strong>Solicitud de Entrada</strong><br>
                                   Folio: <strong>CG{{agencia.folio}}-{{folio}}</strong><br>
                      ...
                      <section>
                       <p>Solicito la <strong>ENTRADA</strong> a las areas del recinto portuario concesionadas a la administracion portuaria 
                         integral de Tabasco S.A. de C.V con Fecha <strong>{{fecha_solicitud}}</strong> al muelle de <strong>{{muelle}}</strong> del personal de cambio de guardia que a continuación se enlistan</p>
                        <div class="row">
                        <div class="col-md-8">
    ...
    <v-container grid-list-sm class="pa-4 white" v-if="verNuevo">
        <v-layout row wrap>
            ...
            <v-flex xs12 sm4 lg4 x14>
              <v-datetime-picker label="Ingrese la fecha de la solicitud" locale="es" v-model="fecha"> </v-datetime-picker>
            </v-flex>
            <v-flex xs12 sm4 lg4 x14>
            ...
            <v-flex xs12 sm4 lg4 x14>
              <v-autocomplete :items="muelles"  v-model="muelle" label="Muelles"></v-autocomplete>
            </v-flex>
             ...
             <v-flex xs12 sm2 md12 lg12 xl12>
               <template>
                 ...
                 >
                          ...
                          <td class="text-xs-center"><v-text-field v-model="props.items.nss"></v-text-field></td>
        ...
        >
          delete
            ...
            <template  v-slot:item.nombreCompleto="{ item }">
             ...
             <template  v-slot:item.nss="{ item }">
                 <td class="text-xs-center"><v-text-field clearable="clearable" v-model="item.nss"></v-text-field></td>
            </template>
      ...
      return{
        ...
        methods: {
          ...
          listar(){
            ...
            let configuracion= {headers: header}
            let me=this;
            axios.get('cambioGuardia/list?valor='+this.$store.state.usuario._id,configuracion).then(function (response){
