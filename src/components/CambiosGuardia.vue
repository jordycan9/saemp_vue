  ...
  <v-flex>
    ...
    >
      <template v-slot:item.estado="{ item }">
        <v-card-text v-if="item.estado" class="blue--text">Aceptado</v-card-text>
        <v-card-text v-if="!item.estado" class="red--text">Anulado</v-card-text>
      </template>
      <template v-slot:top>
        <v-toolbar flat color="white">
          ...
          <v-spacer></v-spacer>
         <v-btn color="primary" v-if="verNuevo==0" @click="mostrarNuevo()" dark class="mb-2">Nuevo Usuario</v-btn>
...
fa fa-file-pdf-o
       ...
       <template v-slot:item.qr="{ item }">
           <qrcode :value="[[item.embarcacion.nombre],[item.folio]]"   :options="{ width: 70 }"></qrcode>
      </template>
    ...
    <v-container grid-list-sm class="pa-4 white" v-if="verNuevo">
        <v-layout row wrap>
           <v-flex xs12 sm4 lg4 x14>
            ...
            <v-flex xs12 sm4 lg4 x14>
              <v-text-field v-model="fecha" type="date" label="Agencia"></v-text-field>
            </v-flex>
            <v-flex xs12 sm4 lg4 x14>
              <v-autocomplete :items="embarcaciones"  v-model="embarcacion" label="Embarcaciones"></v-autocomplete>
            </v-flex>
            ...
            <v-flex xs12 sm4 lg4 x14>
              ...
              <v-textarea v-model="detalles" auto-grow="autoGrow" clearable="clearable" label="Detalles"></v-textarea>
            </v-flex>
  ...
  export default {
    ...
    data(){
      return{
               ...
               { text: 'QR', value: 'qr',sortable:true},
            ],
            editedIndex: -1,
            _id:'',
            embarcacion:'',
        ...
        methods: {
          ...
          listar(){
            ...
            let configuracion= {headers: header}
            let me=this;
            axios.get('cambioGuardia/list',configuracion).then(function (response){
