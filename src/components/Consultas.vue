<template>
  ...
  <v-flex>
      <v-datetime-picker label="Ingrese la Fecha inicial" locale="es" v-model="fecha1"> </v-datetime-picker>
      <v-datetime-picker label="Ingrese la Fecha Final" locale="es" v-model="fecha2"> </v-datetime-picker>
