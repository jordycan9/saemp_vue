            ...
            <v-card>
              ...
              <v-card-actions>
                ...
                <v-btn @click="activarDesactivarCerrar()" small color="error" >
                 ...
                 <v-btn v-if="adAccion==1" @click="aprobarApi()" small color="primary" >
                  Aprobar
                </v-btn>
  ...
  export default {
    ...
    data(){
      return{
               ...
               { text: 'Solicitante', value: 'usuario.nombre', sortable:true},
        ...
        activar(){
          let me=this;
           let header={"Token":this.$store.state.token};
           let configuracion= {headers: header}
           axios.put('solicitudUnica/deactivateApi',{'_id':this.adId,'aprobacionApi':this.$store.state.usuario.nombre},configuracion)
               .then(function(response){
                 me.adModal=0,
                 me.adAccion=0,
                 me.adNombre='',
         ...
         aprobarApi(){
          let me=this;
           let header={"Token":this.$store.state.token};
           let configuracion= {headers: header}
           axios.put('solicitudUnica/aprobarApi',{'_id':this.adId,'aprobacionApi':this.$store.state.usuario.nombre},configuracion)
               .then(function(response){
                 me.adModal=0,
                 me.adAccion=0,
                 me.adNombre='',
